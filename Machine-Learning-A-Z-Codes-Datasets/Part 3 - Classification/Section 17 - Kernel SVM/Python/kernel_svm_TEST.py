...
dataset = pd.read_csv(r'C:\Users\Branden.Weeks\Desktop\ML\Machine-Learning-A-Z-Codes-Datasets\Part 3 - Classification\Section 17 - Kernel SVM\Python\Social_Network_Ads.csv')
...
classifier = SVC(kernel = 'rbf') #kernel creates non-linear model, (does the map to 3D kernel trick  )
